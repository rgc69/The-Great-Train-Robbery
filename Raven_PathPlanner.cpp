...
//---------------------------- ctor -------------------------------------------
//-----------------------------------------------------------------------------
Raven_PathPlanner::Raven_PathPlanner(Veicolo* owner):m_pOwner(owner),
...
int Raven_PathPlanner::GetClosestNodeToPosition(Vector2D pos)const
{
  ...
  //when the cell space is queried this is the range searched for neighboring
...
{ 
  ...
  { 
#ifdef SHOW_NAVINFO
    debug_con << "Nessun nodo vicino al veicolo trovato!" << "";
#endif
  ...
  #ifdef SHOW_NAVINFO
    debug_con << "Il nodo più vicino al veicolo è " << ClosestNodeToBot << "";
#endif
  ...
  { 
#ifdef SHOW_NAVINFO
    debug_con << "Nessun nodo vicino all'obiettivo (" << ClosestNodeToTarget << ") trovato!" << "";
#endif
  ...
  #ifdef SHOW_NAVINFO
    debug_con << "Il nodo più vicino all'obiettivo è " << ClosestNodeToTarget << "";
#endif
...
{    
  ...
  typedef FindActiveTrigger<Trigger<Veicolo> > t_con; 
