...
//-------------------------------- ctor ---------------------------------------
//-----------------------------------------------------------------------------
Raven_TargetingSystem::Raven_TargetingSystem(Veicolo* owner):m_pOwner(owner),
                                                               m_pCurrentTarget(0)
{}
...
void Raven_TargetingSystem::Update()
{
  ...
  std::vector<Veicolo*> SensedBots;
  SensedBots = m_pOwner->GetSensoryMem()->GetListOfRecentlySensedOpponents();
  
  std::vector<Veicolo*>::const_iterator curBot = SensedBots.begin();
