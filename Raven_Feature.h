...
public:
  ...
  static double Health(Veicolo* pBot);
  ...
  static double DistanceToItem(Veicolo* pBot, int ItemType);
  ...
  static double IndividualWeaponStrength(Veicolo* pBot, int WeaponType);
  ...
  static double TotalWeaponStrength(Veicolo* pBot);
};
