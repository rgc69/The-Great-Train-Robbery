...
//---------------------------- ctor -------------------------------------------
//-----------------------------------------------------------------------------
Goal_TraverseEdge::Goal_TraverseEdge(Veicolo* pVeicolo,
                                     PathEdge   edge,
                                     bool       LastEdge):

                                Goal<Veicolo>(pVeicolo, goal_traverse_edge),
                                m_Edge(edge),
                                m_dTimeExpected(0.0),
...
{  
  ...
  {
    debug_con << "VEICOLO " << m_pOwner->ID() << " IS STUCK!!" << "";
