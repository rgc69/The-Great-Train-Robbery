...
char* g_szApplicationName = "La Grande Rapina Al Treno";
char*	g_szWindowClassName = "MyWindowClass";

MondoDiGioco* g_GameWorld;
                             ...
                             LPARAM lParam)
{
    ...
    case WM_CREATE:
      {
         ...
         g_GameWorld = new MondoDiGioco(cxClient, cyClient);
  ...
  case WM_LBUTTONDOWN:
    {
      g_GameWorld->ClickLeftMouseButton(MAKEPOINTS(lParam));
    }
                    ...
                    int       iCmdShow)
{
  ...
  winclass.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(ICON_TRAIN));
  winclass.hCursor	    = LoadCursor(hInstance, MAKEINTRESOURCE(CURSOR_CROSSHAIR));
  winclass.hbrBackground = NULL;
  winclass.lpszMenuName  = MAKEINTRESOURCE(IDR_MENU1);
  winclass.lpszClassName = g_szWindowClassName;
  winclass.hIconSm        = LoadIcon(hInstance, MAKEINTRESOURCE(ICON_TRAIN_SMALL));
