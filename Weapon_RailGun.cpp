...
//--------------------------- ctor --------------------------------------------
//-----------------------------------------------------------------------------
RailGun::RailGun(Veicolo*   owner):

                      Raven_Weapon(type_rail_gun,
                                   15,//script->GetInt("RailGun_DefaultRounds"),
                                   50,//script->GetInt("RailGun_MaxRoundsCarried"),
                                   1,//script->GetDouble("RailGun_FiringFreq"),
                                   200,//script->GetDouble("RailGun_IdealRange"),
...
inline void RailGun::Spara(Vector2D pos)
{ 
  if (NumRoundsRemaining() > 0 && isReadyForNextShot())
  {
    ...
    m_pOwner->GetWorld()->GetMap()->AddSoundTrigger(m_pOwner, 400);//script->GetDouble("RailGun_SoundRange"));
  }
}
