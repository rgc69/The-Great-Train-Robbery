...
//-----------------------------------------------------------------------------
double GetWeaponGoal_Evaluator::CalculateDesirability(Veicolo* pBot)
{
...
//------------------------------ SetGoal --------------------------------------
void GetWeaponGoal_Evaluator::SetGoal(Veicolo* pBot)
{
...
//-------------------------- RenderInfo ---------------------------------------
//-----------------------------------------------------------------------------
void GetWeaponGoal_Evaluator::RenderInfo(Vector2D Position, Veicolo* pBot)
{
  std::string s;
