...
public:
  ...
  virtual double CalculateDesirability(Veicolo* pVeicolo)=0;
  
  //adds the appropriate goal to the given bot's brain
  virtual void  SetGoal(Veicolo* pVeicolo) = 0;

  //used to provide debugging/tweaking support
  virtual void  RenderInfo(Vector2D Position, Veicolo* pVeicolo) = 0;
};
