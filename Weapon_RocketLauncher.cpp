...
//--------------------------- ctor --------------------------------------------
//-----------------------------------------------------------------------------
RocketLauncher::RocketLauncher(Veicolo*   owner):

                      Raven_Weapon(type_rocket_launcher,
                                   15,//script->GetInt("RocketLauncher_DefaultRounds"),
                                   50,//script->GetInt("RocketLauncher_MaxRoundsCarried"),
                                   1.5,//script->GetDouble("RocketLauncher_FiringFreq"),
                                   150,//script->GetDouble("RocketLauncher_IdealRange"),
...
//------------------------------ ShootAt --------------------------------------
//-----------------------------------------------------------------------------
inline void RocketLauncher::Spara(Vector2D pos)
{ 
  if (NumRoundsRemaining() > 0 && isReadyForNextShot())
  {
    ...
    m_pOwner->GetWorld()->GetMap()->AddSoundTrigger(m_pOwner,400);
  }
}
